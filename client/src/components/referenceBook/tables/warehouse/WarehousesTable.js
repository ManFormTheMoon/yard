...
import GroupEditWarehouseModal from "./GroupEditWarehouseModal";
...
const WarehousesTable = (props) => {
  ...
  useEffect(async () => {
    ...
    const response = await fetch("/api/referenceBook/warehouses/get", {
      method: "POST",
      body: body,
      headers: headers,
    });
  ...
  const onSearchClearHandler = () => {
    setCurrentFilters(emptyWarehouse);
  ...
  return (
    <>
      ...
      <AddWarehouseModal
        ...
        emptyWarehouseIds={emptyWarehouseIds}
        showMessage={showMessage}
      />
      <EditWarehouseModal
        ...
        style={style_model}
        emptyWarehouseIds={emptyWarehouseIds}
        currentWarehouseId={selectedRows.length > 0 ? selectedRows[0] : null}
        showMessage={showMessage}
      /> 
      <GroupEditWarehouseModal
      ...
      >
        ...
        >
          <tr>
            ...
            <td>
              <input
                type="text"
                style={{ width: "150px" }}
                placeholder={dictinary.UTC.ru}
                onChange={(event) =>
                  onChangeInputsHandler(event, "UTC")
                }
                value={currentFilters.UTC}
              />
            </td>
            <td>
              <input
          ...
          <tr>
            ...
            <th style={{ minWidth: "150px" }}>{dictinary.UTC.ru}</th>
