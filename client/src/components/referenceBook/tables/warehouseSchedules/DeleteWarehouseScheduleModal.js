...
const DeleteWarehouseScheduleModal = (props) => {
  ...
  const onDeleteEvent = async () => {
    ...
    const response = await fetch("/api/referenceBook/warehouseSchedules/delete", {
      method: "POST",
      body: body,
      headers: headers,
    });
...
export default DeleteWarehouseScheduleModal;
