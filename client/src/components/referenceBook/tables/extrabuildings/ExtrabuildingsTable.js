...
import AddExtrabuildingModal from "./AddExtrabuildingModal";
import "../../style.css";
import EditExtrabuildingModal from "./EditExtrabuildingModal";
import GroupEditExtrabuildingModal from "./GroupEditExtrabuildingModal";
import DeleteExtrabuildingModal from "./DeleteExtrabuildingModal";
...
const ExtrabuildingsTable = (props) => {
  ...
  useEffect(async () => {
    ...
    const response = await fetch("/api/referenceBook/extrabuildings/get", {
      method: "POST",
      body: body,
      headers: headers,
    });
  ...
  const onSearchClearHandler = () => {
    setCurrentFilters(emptyExtrabuilding);
  ...
  return (
    <>
      ...
      />
      <AddExtrabuildingModal
        visible={addModalVisible}
        setVisible={setAddModalVisible}
        style={style_model}
        onSuccesfulAdd={onSuccesfulAdd}
        onUnsuccesfulAdd={onUnsuccesfulAdd}
        emptyExtrabuildingIds={emptyExtrabuildingIds}
        showMessage={showMessage}
      />
      <EditExtrabuildingModal
      ...
      style={style_model}
      emptyExtrabuildingIds={emptyExtrabuildingIds}
      currentExtrabuildingId={selectedRows.length > 0 ? selectedRows[0] : null}
      showMessage={showMessage}
    />
      <GroupEditExtrabuildingModal
        visible={groupEditModalVisible}
        setVisible={setGroupEditModalVisible}
        style={style_model}
        selectedRows={selectedRows}
        emptyExtrabuilding={emptyExtrabuilding}
...
export default ExtrabuildingsTable;
